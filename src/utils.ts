 ...
 */
export async function readTemplate(templateType: string): Promise<string | undefined> {
 ...
 */
export function formatTemplate(template: string, customVars: Record<string, string> = {}): string {
  const now = new Date();
